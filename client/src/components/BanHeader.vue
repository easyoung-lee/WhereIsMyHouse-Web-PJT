        ...
        <div class="col-lg-9 mt-4 mx-auto">
          ...
          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="text-default" href="/">{{ parent }} &nbsp; &nbsp; /</a>
            </li>
            <li class="list-inline-item text-primary">{{ child }}</li>
          </ul>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    // 감시하고 싶은 state..
    ...mapGetters(['banner', 'parent', 'child']),
  },
  created() {
    //DOM객체와 연결되었고 Vue의 속성들도 초기화 된 상태
  },
  methods: {
    // store.commit('setBanner', 'Where is<br/>My House?'),
  },
};
</script>
<style></style>
